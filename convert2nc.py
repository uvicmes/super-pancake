...
def convert2nc(srcpath, outpath):
    ...
    for file in files:
        ...
        for index, row in csvdf.iterrows():
            ...
            nvb4.append((csvdf[26][index])), evb5.append((csvdf[27][index])), nvb5.append((csvdf[28][index]))
            evb6.append((csvdf[29][index])), nvb6.append((csvdf[30][index])), evb7.append((csvdf[31][index]))
            nvb7.append((csvdf[32][index])), evb8.append((csvdf[33][index])), nvb8.append((csvdf[34][index]))
            evb9.append((csvdf[35][index])), nvb9.append((csvdf[36][index])), evb10.append((csvdf[37][index]))
            nvb10.append((csvdf[38][index])), evb11.append((csvdf[39][index])), nvb11.append((csvdf[40][index]))
            evb12.append((csvdf[41][index])), nvb12.append((csvdf[42][index])), evb13.append((csvdf[43][index]))
            nvb13.append((csvdf[44][index])), evb14.append((csvdf[45][index])), nvb14.append((csvdf[46][index]))
            evb15.append((csvdf[47][index])), nvb15.append((csvdf[48][index])), evb16.append((csvdf[49][index]))
            nvb16.append((csvdf[50][index])), evb17.append((csvdf[51][index])), nvb17.append((csvdf[52][index]))
            evb18.append((csvdf[53][index])), nvb18.append((csvdf[54][index])), evb19.append((csvdf[55][index]))
            nvb19.append((csvdf[56][index])), evb20.append((csvdf[57][index])), nvb20.append((csvdf[58][index]))
        ...
        east_velocity2.short_name = "EVB02"
        east_velocity2.units = "02mm/s"
        east_velocity2.measurement_type = "measured"
        east_velocity2.is_dead = "N/A"
        east_velocity2[:] = evb2

        north_velocity2 = dataset.createVariable("NVB02", "f8", ("time", "lon", "lat",))
        north_velocity2.long_name = "North Velocity Bin 02"
        north_velocity2.standard_name = "north_velocity_bin_02"
        north_velocity2.short_name = "NVB02"
        north_velocity2.units = "02mm/s"
        north_velocity2.measurement_type = "measured"
        north_velocity2.is_dead = "N/A"
        north_velocity2[:] = nvb2

        east_velocity3 = dataset.createVariable("EVB03", "f8", ("time", "lon", "lat",))
        east_velocity3.long_name = "East Velocity Bin 03"
        east_velocity3.standard_name = "east_velocity_bin_03"
        east_velocity3.short_name = "EVB03"
        east_velocity3.units = "03mm/s"
        east_velocity3.measurement_type = "measured"
        east_velocity3.is_dead = "N/A"
        east_velocity3[:] = evb3

        north_velocity3 = dataset.createVariable("NVB03", "f8", ("time", "lon", "lat",))
        north_velocity3.long_name = "North Velocity Bin 03"
        north_velocity3.standard_name = "north_velocity_bin_03"
        north_velocity3.short_name = "NVB03"
        north_velocity3.units = "03mm/s"
        north_velocity3.measurement_type = "measured"
        north_velocity3.is_dead = "N/A"
        north_velocity3[:] = nvb3

        east_velocity4 = dataset.createVariable("EVB04", "f8", ("time", "lon", "lat",))
        east_velocity4.long_name = "East Velocity Bin 04"
        east_velocity4.standard_name = "east_velocity_bin_04"
        east_velocity4.short_name = "EVB04"
        east_velocity4.units = "04mm/s"
        east_velocity4.measurement_type = "measured"
        east_velocity4.is_dead = "N/A"
        east_velocity4[:] = evb4

        north_velocity4 = dataset.createVariable("NVB04", "f8", ("time", "lon", "lat",))
        north_velocity4.long_name = "North Velocity Bin 04"
        north_velocity4.standard_name = "north_velocity_bin_04"
        north_velocity4.short_name = "NVB04"
        north_velocity4.units = "04mm/s"
        north_velocity4.measurement_type = "measured"
        north_velocity4.is_dead = "N/A"
        north_velocity4[:] = nvb4

        east_velocity5 = dataset.createVariable("EVB05", "f8", ("time", "lon", "lat",))
        east_velocity5.long_name = "East Velocity Bin 05"
        east_velocity5.standard_name = "east_velocity_bin_05"
        east_velocity5.short_name = "EVB05"
        east_velocity5.units = "05mm/s"
        east_velocity5.measurement_type = "measured"
        east_velocity5.is_dead = "N/A"
        east_velocity5[:] = evb5

        north_velocity5 = dataset.createVariable("NVB05", "f8", ("time", "lon", "lat",))
        north_velocity5.long_name = "North Velocity Bin 05"
        north_velocity5.standard_name = "north_velocity_bin_05"
        north_velocity5.short_name = "NVB05"
        north_velocity5.units = "05mm/s"
        north_velocity5.measurement_type = "measured"
        north_velocity5.is_dead = "N/A"
        north_velocity5[:] = nvb5

        east_velocity6 = dataset.createVariable("EVB06", "f8", ("time", "lon", "lat",))
        east_velocity6.long_name = "East Velocity Bin 06"
        east_velocity6.standard_name = "east_velocity_bin_06"
        east_velocity6.short_name = "EVB06"
        east_velocity6.units = "06mm/s"
        east_velocity6.measurement_type = "measured"
        east_velocity6.is_dead = "N/A"
        east_velocity6[:] = evb6

        north_velocity6 = dataset.createVariable("NVB06", "f8", ("time", "lon", "lat",))
        north_velocity6.long_name = "North Velocity Bin 06"
        north_velocity6.standard_name = "north_velocity_bin_06"
        north_velocity6.short_name = "NVB06"
        north_velocity6.units = "06mm/s"
        north_velocity6.measurement_type = "measured"
        north_velocity6.is_dead = "N/A"
        north_velocity6[:] = nvb6

        east_velocity7 = dataset.createVariable("EVB07", "f8", ("time", "lon", "lat",))
        east_velocity7.long_name = "East Velocity Bin 07"
        east_velocity7.standard_name = "east_velocity_bin_07"
        east_velocity7.short_name = "EVB07"
        east_velocity7.units = "07mm/s"
        east_velocity7.measurement_type = "measured"
        east_velocity7.is_dead = "N/A"
        east_velocity7[:] = evb7

        north_velocity7 = dataset.createVariable("NVB07", "f8", ("time", "lon", "lat",))
        north_velocity7.long_name = "North Velocity Bin 07"
        north_velocity7.standard_name = "north_velocity_bin_07"
        north_velocity7.short_name = "NVB07"
        north_velocity7.units = "07mm/s"
        north_velocity7.measurement_type = "measured"
        north_velocity7.is_dead = "N/A"
        north_velocity7[:] = nvb7

        east_velocity8 = dataset.createVariable("EVB08", "f8", ("time", "lon", "lat",))
        east_velocity8.long_name = "East Velocity Bin 08"
        east_velocity8.standard_name = "east_velocity_bin_08"
        east_velocity8.short_name = "EVB08"
        east_velocity8.units = "08mm/s"
        east_velocity8.measurement_type = "measured"
        east_velocity8.is_dead = "N/A"
        east_velocity8[:] = evb8

        north_velocity8 = dataset.createVariable("NVB08", "f8", ("time", "lon", "lat",))
        north_velocity8.long_name = "North Velocity Bin 08"
        north_velocity8.standard_name = "north_velocity_bin_08"
        north_velocity8.short_name = "NVB08"
        north_velocity8.units = "08mm/s"
        north_velocity8.measurement_type = "measured"
        north_velocity8.is_dead = "N/A"
        north_velocity8[:] = nvb8

        east_velocity9 = dataset.createVariable("EVB09", "f8", ("time", "lon", "lat",))
        east_velocity9.long_name = "East Velocity Bin 09"
        east_velocity9.standard_name = "east_velocity_bin_09"
        east_velocity9.short_name = "EVB09"
        east_velocity9.units = "09mm/s"
        east_velocity9.measurement_type = "measured"
        east_velocity9.is_dead = "N/A"
        east_velocity9[:] = evb9

        north_velocity9 = dataset.createVariable("NVB09", "f8", ("time", "lon", "lat",))
        north_velocity9.long_name = "North Velocity Bin 09"
        north_velocity9.standard_name = "north_velocity_bin_09"
        north_velocity9.short_name = "NVB09"
        north_velocity9.units = "09mm/s"
        north_velocity9.measurement_type = "measured"
        north_velocity9.is_dead = "N/A"
        north_velocity9[:] = nvb9

        east_velocity10 = dataset.createVariable("EVB010", "f8", ("time", "lon", "lat",))
        east_velocity10.long_name = "East Velocity Bin 10"
        east_velocity10.standard_name = "east_velocity_bin_10"
        east_velocity10.short_name = "EVB010"
        east_velocity10.units = "10mm/s"
        east_velocity10.measurement_type = "measured"
        east_velocity10.is_dead = "N/A"
        east_velocity10[:] = evb10

        north_velocity10 = dataset.createVariable("NVB10", "f8", ("time", "lon", "lat",))
        north_velocity10.long_name = "North Velocity Bin 10"
        north_velocity10.standard_name = "north_velocity_bin_10"
        north_velocity10.short_name = "NVB10"
        north_velocity10.units = "10mm/s"
        north_velocity10.measurement_type = "measured"
        north_velocity10.is_dead = "N/A"
        north_velocity10[:] = nvb10

        east_velocity11 = dataset.createVariable("EVB11", "f8", ("time", "lon", "lat",))
        east_velocity11.long_name = "East Velocity Bin 11"
        east_velocity11.standard_name = "east_velocity_bin_11"
        east_velocity11.short_name = "EVB11"
        east_velocity11.units = "11mm/s"
        east_velocity11.measurement_type = "measured"
        east_velocity11.is_dead = "N/A"
        east_velocity11[:] = evb11

        north_velocity11 = dataset.createVariable("NVB11", "f8", ("time", "lon", "lat",))
        north_velocity11.long_name = "North Velocity Bin 11"
        north_velocity11.standard_name = "north_velocity_bin_11"
        north_velocity11.short_name = "NVB11"
        north_velocity11.units = "11mm/s"
        north_velocity11.measurement_type = "measured"
        north_velocity11.is_dead = "N/A"
        north_velocity11[:] = nvb11

        east_velocity12 = dataset.createVariable("EVB12", "f8", ("time", "lon", "lat",))
        east_velocity12.long_name = "East Velocity Bin 12"
        east_velocity12.standard_name = "east_velocity_bin_12"
        east_velocity12.short_name = "EVB12"
        east_velocity12.units = "12mm/s"
        east_velocity12.measurement_type = "measured"
        east_velocity12.is_dead = "N/A"
        east_velocity12[:] = evb12

        north_velocity12 = dataset.createVariable("NVB12", "f8", ("time", "lon", "lat",))
        north_velocity12.long_name = "North Velocity Bin 12"
        north_velocity12.standard_name = "north_velocity_bin_12"
        north_velocity12.short_name = "NVB12"
        north_velocity12.units = "12mm/s"
        north_velocity12.measurement_type = "measured"
        north_velocity12.is_dead = "N/A"
        north_velocity12[:] = nvb12

        east_velocity13 = dataset.createVariable("EVB13", "f8", ("time", "lon", "lat",))
        east_velocity13.long_name = "East Velocity Bin 13"
        east_velocity13.standard_name = "east_velocity_bin_13"
        east_velocity13.short_name = "EVB13"
        east_velocity13.units = "13mm/s"
        east_velocity13.measurement_type = "measured"
        east_velocity13.is_dead = "N/A"
        east_velocity13[:] = evb13

        north_velocity13 = dataset.createVariable("NVB13", "f8", ("time", "lon", "lat",))
        north_velocity13.long_name = "North Velocity Bin 13"
        north_velocity13.standard_name = "north_velocity_bin_13"
        north_velocity13.short_name = "NVB13"
        north_velocity13.units = "13mm/s"
        north_velocity13.measurement_type = "measured"
        north_velocity13.is_dead = "N/A"
        north_velocity13[:] = nvb13

        east_velocity14 = dataset.createVariable("EVB14", "f8", ("time", "lon", "lat",))
        east_velocity14.long_name = "East Velocity Bin 14"
        east_velocity14.standard_name = "east_velocity_bin_14"
        east_velocity14.short_name = "EVB14"
        east_velocity14.units = "14mm/s"
        east_velocity14.measurement_type = "measured"
        east_velocity14.is_dead = "N/A"
        east_velocity14[:] = evb14

        north_velocity14 = dataset.createVariable("NVB14", "f8", ("time", "lon", "lat",))
        north_velocity14.long_name = "North Velocity Bin 14"
        north_velocity14.standard_name = "north_velocity_bin_14"
        north_velocity14.short_name = "NVB14"
        north_velocity14.units = "14mm/s"
        north_velocity14.measurement_type = "measured"
        north_velocity14.is_dead = "N/A"
        north_velocity14[:] = nvb14

        east_velocity15 = dataset.createVariable("EVB15", "f8", ("time", "lon", "lat",))
        east_velocity15.long_name = "East Velocity Bin 15"
        east_velocity15.standard_name = "east_velocity_bin_15"
        east_velocity15.short_name = "EVB15"
        east_velocity15.units = "15mm/s"
        east_velocity15.measurement_type = "measured"
        east_velocity15.is_dead = "N/A"
        east_velocity15[:] = evb15

        north_velocity15 = dataset.createVariable("NVB15", "f8", ("time", "lon", "lat",))
        north_velocity15.long_name = "North Velocity Bin 15"
        north_velocity15.standard_name = "north_velocity_bin_15"
        north_velocity15.short_name = "NVB15"
        north_velocity15.units = "15mm/s"
        north_velocity15.measurement_type = "measured"
        north_velocity15.is_dead = "N/A"
        north_velocity15[:] = nvb15

        east_velocity16 = dataset.createVariable("EVB16", "f8", ("time", "lon", "lat",))
        east_velocity16.long_name = "East Velocity Bin 16"
        east_velocity16.standard_name = "east_velocity_bin_16"
        east_velocity16.short_name = "EVB16"
        east_velocity16.units = "16mm/s"
        east_velocity16.measurement_type = "measured"
        east_velocity16.is_dead = "N/A"
        east_velocity16[:] = evb16

        north_velocity16 = dataset.createVariable("NVB16", "f8", ("time", "lon", "lat",))
        north_velocity16.long_name = "North Velocity Bin 16"
        north_velocity16.standard_name = "north_velocity_bin_16"
        north_velocity16.short_name = "NVB16"
        north_velocity16.units = "16mm/s"
        north_velocity16.measurement_type = "measured"
        north_velocity16.is_dead = "N/A"
        north_velocity16[:] = nvb16

        east_velocity17 = dataset.createVariable("EVB17", "f8", ("time", "lon", "lat",))
        east_velocity17.long_name = "East Velocity Bin 17"
        east_velocity17.standard_name = "east_velocity_bin_17"
        east_velocity17.short_name = "EVB17"
        east_velocity17.units = "17mm/s"
        east_velocity17.measurement_type = "measured"
        east_velocity17.is_dead = "N/A"
        east_velocity17[:] = evb17

        north_velocity17 = dataset.createVariable("NVB17", "f8", ("time", "lon", "lat",))
        north_velocity17.long_name = "North Velocity Bin 17"
        north_velocity17.standard_name = "north_velocity_bin_17"
        north_velocity17.short_name = "NVB17"
        north_velocity17.units = "17mm/s"
        north_velocity17.measurement_type = "measured"
        north_velocity17.is_dead = "N/A"
        north_velocity17[:] = nvb17

        east_velocity18 = dataset.createVariable("EVB18", "f8", ("time", "lon", "lat",))
        east_velocity18.long_name = "East Velocity Bin 18"
        east_velocity18.standard_name = "east_velocity_bin_18"
        east_velocity18.short_name = "EVB18"
        east_velocity18.units = "18mm/s"
        east_velocity18.measurement_type = "measured"
        east_velocity18.is_dead = "N/A"
        east_velocity18[:] = evb18

        north_velocity18 = dataset.createVariable("NVB18", "f8", ("time", "lon", "lat",))
        north_velocity18.long_name = "North Velocity Bin 18"
        north_velocity18.standard_name = "north_velocity_bin_18"
        north_velocity18.short_name = "NVB18"
        north_velocity18.units = "18mm/s"
        north_velocity18.measurement_type = "measured"
        north_velocity18.is_dead = "N/A"
        north_velocity18[:] = nvb18

        east_velocity19 = dataset.createVariable("EVB19", "f8", ("time", "lon", "lat",))
        east_velocity19.long_name = "East Velocity Bin 19"
        east_velocity19.standard_name = "east_velocity_bin_19"
        east_velocity19.short_name = "EVB19"
        east_velocity19.units = "19mm/s"
        east_velocity19.measurement_type = "measured"
        east_velocity19.is_dead = "N/A"
        east_velocity19[:] = evb19

        north_velocity19 = dataset.createVariable("NVB19", "f8", ("time", "lon", "lat",))
        north_velocity19.long_name = "North Velocity Bin 19"
        north_velocity19.standard_name = "north_velocity_bin_19"
        north_velocity19.short_name = "NVB19"
        north_velocity19.units = "19mm/s"
        north_velocity19.measurement_type = "measured"
        north_velocity19.is_dead = "N/A"
        north_velocity19[:] = nvb19

        east_velocity20 = dataset.createVariable("EVB20", "f8", ("time", "lon", "lat",))
        east_velocity20.long_name = "East Velocity Bin 20"
        east_velocity20.standard_name = "east_velocity_bin_20"
        east_velocity20.short_name = "EVB20"
        east_velocity20.units = "20mm/s"
        east_velocity20.measurement_type = "measured"
        east_velocity20.is_dead = "N/A"
        east_velocity20[:] = evb20

        north_velocity20 = dataset.createVariable("NVB20", "f8", ("time", "lon", "lat",))
        north_velocity20.long_name = "North Velocity Bin 20"
        north_velocity20.standard_name = "north_velocity_bin_20"
        north_velocity20.short_name = "NVB20"
        north_velocity20.units = "20mm/s"
