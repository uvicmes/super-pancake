...
def convert2nc(srcpath, outpath):
    ...
    for file in files:
        ...
        for index, row in csvdf.iterrows():
            ...
            pgb.append((csvdf[61][index])), pgb.append((csvdf[62][index])), pgb.append((csvdf[63][index]))
            pgb.append((csvdf[64][index])), pgb.append((csvdf[65][index])), pgb.append((csvdf[66][index]))
            pgb.append((csvdf[67][index])), pgb.append((csvdf[68][index])), pgb.append((csvdf[69][index]))
            pgb.append((csvdf[70][index])), pgb.append((csvdf[71][index])), pgb.append((csvdf[72][index]))
            pgb.append((csvdf[73][index])), pgb.append((csvdf[74][index])), pgb.append((csvdf[75][index]))
            pgb.append((csvdf[76][index])), pgb.append((csvdf[77][index])), pgb.append((csvdf[78][index]))
            pgb.append((csvdf[79][index])), pgb.append((csvdf[80][index]))
    ...
    #bug displaying excess of "_," values for no reason....
    times = dataset.createVariable("time", "f8", ('time',))
    times.long_name = "Datetime"
    ...
    barometric_pressure.comments = "Air Pressure"
